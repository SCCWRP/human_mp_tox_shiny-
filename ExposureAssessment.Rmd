...
To determine the mass of particles in drinking water, a simulated distribution of particles (including shape, density, volume, mass, and relative abundance) is generated, based on equations and probability density functions described in Kooi and Koelmans (2019).
...
For polymer abundance, fixed values from Burns & Boxall (2018) are applied which are used to determine density. Given these fixed relative abundances, polymer type is randomly generated for N particles via: 
...
The parameters for fitting shape, density, and mass of microplastics particles for converting between number and mass are taken from Kooi and Koelmans (2019). 

The probability density function for the occurence of microplastics in tap water is generated based on Mohamed Nor et al (2021) (Table S7) for 'food' - as the authors reported that there are no significant differences between tap water and other food matrices for these parameters.
...
The above code generates 10,000 particles. The distributions are visualized below.
...
From this distribution of simulated microplastics in drinking water, the 1-10 micron fraction will be considered to be bioavailable. Below is a table summarizing the mass of particles in discrete size bins within this simulated distribution. 
...
```{r}
paste("average mass of 1-10 micron particles:",summaryDistribution$`Average Mass (mg)`[1], "mg")
```
...
The following code generates occurence distribution for microplastics in tap water based on the bimodal PDf in Mohamed Nor et al (2021).
...
```
Below is a histogram of the occurence of microplastics in tap water in the PDF.
...
## Summary Table of Exposure Sources

Below is  table of summary statistics for microplastics occurence in various exposure media. Values are from Mohamed Nor et al (2021).
```{r paged.print=TRUE}
...
When developing health-protective concentrations for noncancer effects based on animal toxicity studies, OEHHA generally applies a composite UF of 300, consisting of 10 for interspecies extrapolation (10 for particokinetics and 10 for
particodynamics) and 30 for intraspecies variability (OEHHA, 2008).

When calculating the ADD for microplastics using the POD from Hou et al. (2021), an interspecies UF of 10 was applied to account for potential differences in particodynamics when extrapolating data from animal studies to humans. An uncertainty factor of 10 for interspecies extrapolation is applied due to lack of data for converting between animal and human studies for microplastics. An uncertainty factor of 30 is applied for intraspecies variability. An uncertainty factor of 10 for LOAEL to NOAEL is used. Although the critical threshold study was subchronic (<8% of the animal's lifetime), no uncertainty factors were applied to convert to chronic because the 35-day exposure covers an entire sperm cycle (from spermatogonia to mature spermatozoa).An additional uncertainty factor of 10 is applied for LOAEL to NOAEL. The composite uncertainty factor is 10 x 30 x 10 = *3,000*.
...
Thus, the acceptable daily dose (ADD) is 5.7e-6 mg/kg-day.
...
The 70-yr lifetime weighted average (0.053 L/kg-day) drinking water intake (DWI) rate is used. for health-protective concentration. 
...
paste("volume of 5-micron polystyrene sphere:",round(particle.volume,1), "um^3")
```
...
paste("mass per particle for 5 um polystyrene sphere:", signif(particle.mass.ug,3),"ug/particle")
```
...
paste("health protection concentration:",signif(C.part.L.5um.PS.spheres,3),"5-um Polystyrene Spherical Particles/L")
```
...
# NEED TO DO: CONVERT ALL PARTICLES IN DRINKING WATER TO MASS/L # HAZIMAH MAY HELP
...
The following is a table of summary statistics for *total* estimated exposure of microplastics to humans based on Mohamed Nor et al (2021).
...
```
### Total Risk Exceendace
A simple plot relating total estimated exposure to the ADD is shown below.
...
Below is a table estimating the percent exceedance of the health-protective concentration (particles/L) for tap water based on the PDF in Mohamed Nor et al (2021). Notification Level (NL) = Health protection concentration. Reponse Level (RL) = 10 x NL.
```{r}
...
### Tap Water Exceedance
Below is a plot of the probability density function of microplastics in tap water with NL and RL annotated.
...
Alternatively, the concentration of microplastics in tap water can be displayed in estimated mass (ug/L) alongside the health-protective concentration. *THIS SECTION IS INCOMPLETE. NEED TO ESTIMATE MASS FOR EACH PARTICLE IN DISTRIBUTION USING PDFs FROM HAZIMAH*
...
Percent exceedance of NL/RL in tap water may be visualzed as a cumulative density fuction.
...
Amereh, Fatemeh, Mohammad Babaei, Akbar Eslami, Simin Fazelipour, and Mohammad Rafiee. 2020. “The Emerging Risk of Exposure to Nano(Micro)Plastics on Endocrine Disturbance and Reproductive Toxicity: From a Hypothetical Scenario to a Global Public Health Challenge.” Environmental Pollution 261 (June): 114158. https://doi.org/10.1016/j.envpol.2020.114158.

Amereh, Fatemeh, Akbar Eslami, Simin Fazelipour, Mohammad Rafiee, Mohammad Ismail Zibaii, and Mohammad Babaei. 2019. “Thyroid Endocrine Status and Biochemical Stress Responses in Adult Male Wistar Rats Chronically Exposed to Pristine Polystyrene Nanoplastics.” Toxicology Research 8 (6): 953–63. https://doi.org/10.1039/c9tx00147f.

Hou, Baolian, Fangyi Wang, Tao Liu, and Zhiping Wang. 2021. “Reproductive Toxicity of Polystyrene Microplastics: In Vivo Experimental Study on Testicular Toxicity in Mice.” Journal of Hazardous Materials 405 (March): 124028. https://doi.org/10.1016/j.jhazmat.2020.124028.

Kooi, Merel, and Albert A Koelmans. 2019. “Simplifying Microplastic via Continuous Probability Distributions for Size, Shape, and Density.” Environmental Science & Technology Letters 6 (9): 551–57.

Li, Zekang, Shuxiang Zhu, Qian Liu, Jialiu Wei, Yinchuan Jin, Xifeng Wang, and Lianshuang Zhang. 2020. “Polystyrene Microplastics Cause Cardiac Fibrosis by Activating Wnt/β-Catenin Signaling Pathway and Promoting Cardiomyocyte Apoptosis in Rats.” Environmental Pollution 265 (October): 115025. https://doi.org/10.1016/j.envpol.2020.115025.

Park, Eun-Jung, Ji-Seok Han, Eun-Jun Park, Eunsol Seong, Gwang-Hee Lee, Dong-Wan Kim, Hwa-Young Son, Hyoung-Yun Han, and Byoung-Seok Lee. 2020. “Repeated-Oral Dose Toxicity of Polyethylene Microplastics and the Possible Implications on Reproduction and Development of the next Generation.” Toxicology Letters 324 (May): 75–85. https://doi.org/10.1016/j.toxlet.2020.01.008.

Wei, Jialiu, Xifeng Wang, Qian Liu, Na Zhou, Shuxiang Zhu, Zekang Li, Xiaoli Li, Jinpeng Yao, and Lianshuang Zhang. 2021. “The Impact of Polystyrene Microplastics on Cardiomyocytes Pyroptosis through NLRP3 /Caspase‐1 Signaling Pathway and Oxidative Stress in Wistar Rats.” Environmental Toxicology, January, tox.23095. https://doi.org/10.1002/tox.23095.

Xie, Xiaoman, Ting Deng, Jiufei Duan, Jing Xie, Junlin Yuan, and Mingqing Chen. 2020. “Exposure to Polystyrene Microplastics Causes Reproductive Toxicity through Oxidative Stress and Activation of the P38 MAPK Signaling Pathway.” Ecotoxicology and Environmental Safety 190 (March): 110133. https://doi.org/10.1016/j.ecoenv.2019.110133.


Mohamed Nor et al (2021). "Lifetime accumulation of microplastic in children and adults." Environmental Science & Technology.
